...
set resultDir ..\/..\/result\/conv32to48
file mkdir $resultDir
create_project pkg_conv32to48 ..\/..\/result\/conv32to48 -part xc7z010clg400-1 -force


# KORAK#2: Ukljucivanje svih izvornih fajlova u projekat
add_files -norecurse ..\/hdl\/conv32to48.vhd
...
set_property name conv32to48 [ipx::current_core]
set_property display_name conv32to48-1.0 [ipx::current_core]
set_property description {Convert to FFT} [ipx::current_core]
...
ipx::archive_core ..\/..\/conv32to48_v1_0.zip [ipx::current_core]
close_project
