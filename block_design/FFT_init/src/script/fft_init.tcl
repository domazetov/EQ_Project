...
set resultDir ..\/..\/result\/fft_init
file mkdir $resultDir
create_project pkg_fft_init ..\/..\/result\/fft_init -part xc7z010clg400-1 -force


# KORAK#2: Ukljucivanje svih izvornih fajlova u projekat
add_files -norecurse ..\/hdl\/fft_init.vhd
...
set_property name fft_init [ipx::current_core]
set_property display_name fft_init-1.0 [ipx::current_core]
set_property description {FFT initialisation} [ipx::current_core]
...
ipx::archive_core ..\/..\/fft_init_v1_0.zip [ipx::current_core]
close_project
