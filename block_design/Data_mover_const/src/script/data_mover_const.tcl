...
set resultDir ..\/..\/result\/data_mover_const
file mkdir $resultDir
create_project pkg_data_mover_const ..\/..\/result\/data_mover_const -part xc7z010clg400-1 -force


# KORAK#2: Ukljucivanje svih izvornih fajlova u projekat
add_files -norecurse ..\/hdl\/data_mover_const.vhd
...
set_property name data_mover_const [ipx::current_core]
set_property display_name data_mover_const-1.0 [ipx::current_core]
set_property description {Constant for Data Mover} [ipx::current_core]
...
ipx::archive_core ..\/..\/data_mover_const_v1_0.zip [ipx::current_core]
close_project
