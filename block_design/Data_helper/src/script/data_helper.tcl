...
set resultDir ..\/..\/result\/data_helper
file mkdir $resultDir
create_project pkg_data_helper ..\/..\/result\/data_helper -part xc7z010clg400-1 -force
...
set_property description {Data mover helper} [ipx::current_core]
...
ipx::archive_core ..\/..\/data_helper_v1_0.zip [ipx::current_core]
close_project
